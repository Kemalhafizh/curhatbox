...
from main.models import Message, Profile, QnASession
...
class ModelsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.user1 = User.objects.create_user(
            username="testuser_satu", email="t1@mail.com", password="pwd"
        )
        self.user2 = User.objects.create_user(
            username="testuser_dua", email="t2@mail.com", password="pwd"
        )
    ...
    def test_profile_slug_generation(self):
        ...
        user_unik = User.objects.create_user(
            username="Bang Jago 123!", email="bj@mail.com", password="pwd"
        )
    ...
    def test_user_cascade_deletion(self):
        ...
        Message.objects.create(
            recipient=self.user1, content="Pesan Sampah", qna_session=qna
        )
